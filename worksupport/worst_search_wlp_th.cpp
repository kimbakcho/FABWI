...
worst_search_WLP_th::worst_search_WLP_th()
{
    ...
    REWORK_ITEM_LIST.append(tr("paticle"));
...
QVector<defect_worst_type_WLP> worst_search_WLP_th::getB_defect_worstcpsprocesslist() const
{
    return b_defect_worstcpsprocesslist;
}

void worst_search_WLP_th::setB_defect_worstcpsprocesslist(const QVector<defect_worst_type_WLP> &value)
{
    b_defect_worstcpsprocesslist = value;
}

QVector<defect_worst_type_WLP> worst_search_WLP_th::getDefect_worstcpsprocesslist() const
{
    return defect_worstcpsprocesslist;
}

void worst_search_WLP_th::setDefect_worstcpsprocesslist(const QVector<defect_worst_type_WLP> &value)
{
    defect_worstcpsprocesslist = value;
}

QVector<rework_text_type_WLP> worst_search_WLP_th::getB_rework_worstcpsprocesslist() const
{
    return b_rework_worstcpsprocesslist;
}

void worst_search_WLP_th::setB_rework_worstcpsprocesslist(const QVector<rework_text_type_WLP> &value)
{
    b_rework_worstcpsprocesslist = value;
}

QVector<rework_text_type_WLP> worst_search_WLP_th::getRework_worstcpsprocesslist() const
{
    return rework_worstcpsprocesslist;
}

void worst_search_WLP_th::setRework_worstcpsprocesslist(const QVector<rework_text_type_WLP> &value)
{
...
double worst_search_WLP_th::getB_exterior_worst_count() const
{
    return b_exterior_worst_count;
}

void worst_search_WLP_th::setB_exterior_worst_count(double value)
{
    b_exterior_worst_count = value;
}

double worst_search_WLP_th::getB_exterior_vaild() const
{
    return b_exterior_vaild;
}

void worst_search_WLP_th::setB_exterior_vaild(double value)
{
    b_exterior_vaild = value;
}

double worst_search_WLP_th::getB_exterior_brigitpadworst_vaild() const
{
    return b_exterior_brigitpadworst_vaild;
}

void worst_search_WLP_th::setB_exterior_brigitpadworst_vaild(double value)
{
    b_exterior_brigitpadworst_vaild = value;
}

double worst_search_WLP_th::getB_exterior_etcpaticle_vaild() const
{
    return b_exterior_etcpaticle_vaild;
}

void worst_search_WLP_th::setB_exterior_etcpaticle_vaild(double value)
{
    b_exterior_etcpaticle_vaild = value;
}

double worst_search_WLP_th::getB_exterior_sindiseatching_vaild() const
{
    return b_exterior_sindiseatching_vaild;
}

void worst_search_WLP_th::setB_exterior_sindiseatching_vaild(double value)
{
    b_exterior_sindiseatching_vaild = value;
}

double worst_search_WLP_th::getB_exterior_padpaticle_vaild() const
{
    return b_exterior_padpaticle_vaild;
}

void worst_search_WLP_th::setB_exterior_padpaticle_vaild(double value)
{
    b_exterior_padpaticle_vaild = value;
}

double worst_search_WLP_th::getB_exterior_pattenpaticle_vaild() const
{
    return b_exterior_pattenpaticle_vaild;
}

void worst_search_WLP_th::setB_exterior_pattenpaticle_vaild(double value)
{
    b_exterior_pattenpaticle_vaild = value;
}

double worst_search_WLP_th::getTotal_b_Jobmiss_probe() const
{
    return total_b_Jobmiss_probe;
}

void worst_search_WLP_th::setTotal_b_Jobmiss_probe(double value)
{
    total_b_Jobmiss_probe = value;
}

double worst_search_WLP_th::getTotal_b_Jobmiss_light() const
{
    return total_b_Jobmiss_light;
}

void worst_search_WLP_th::setTotal_b_Jobmiss_light(double value)
{
    total_b_Jobmiss_light = value;
}

double worst_search_WLP_th::getTotal_b_Jobmiss_eatching() const
{
    return total_b_Jobmiss_eatching;
}

void worst_search_WLP_th::setTotal_b_Jobmiss_eatching(double value)
{
    total_b_Jobmiss_eatching = value;
}

double worst_search_WLP_th::getTotal_b_Jobmiss_defect() const
{
    return total_b_Jobmiss_defect;
}

void worst_search_WLP_th::setTotal_b_Jobmiss_defect(double value)
{
    total_b_Jobmiss_defect = value;
}

double worst_search_WLP_th::getTotal_b_Rework_paticle() const
{
    return total_b_Rework_paticle;
}

void worst_search_WLP_th::setTotal_b_Rework_paticle(double value)
{
    total_b_Rework_paticle = value;
}

double worst_search_WLP_th::getTotal_b_brigit_pad_worst() const
{
    return total_b_brigit_pad_worst;
}

void worst_search_WLP_th::setTotal_b_brigit_pad_worst(double value)
{
    total_b_brigit_pad_worst = value;
}

double worst_search_WLP_th::getTotal_b_Defectpaticle() const
{
    return total_b_Defectpaticle;
}

void worst_search_WLP_th::setTotal_b_Defectpaticle(double value)
{
    total_b_Defectpaticle = value;
}

double worst_search_WLP_th::getTotal_b_Pattenpaticle() const
{
    return total_b_Pattenpaticle;
}

void worst_search_WLP_th::setTotal_b_Pattenpaticle(double value)
{
    total_b_Pattenpaticle = value;
}

double worst_search_WLP_th::getTotal_b_Etcpaticle() const
{
    return total_b_Etcpaticle;
}

void worst_search_WLP_th::setTotal_b_Etcpaticle(double value)
{
    total_b_Etcpaticle = value;
}

double worst_search_WLP_th::getTotal_b_Padpaticle() const
{
    return total_b_Padpaticle;
}

void worst_search_WLP_th::setTotal_b_Padpaticle(double value)
{
    total_b_Padpaticle = value;
}

double worst_search_WLP_th::getTotal_b_Machinefail_defect() const
{
    return total_b_Machinefail_defect;
}

void worst_search_WLP_th::setTotal_b_Machinefail_defect(double value)
{
    total_b_Machinefail_defect = value;
}

double worst_search_WLP_th::getTotal_b_Machinefail_light() const
{
    return total_b_Machinefail_light;
}

void worst_search_WLP_th::setTotal_b_Machinefail_light(double value)
{
    total_b_Machinefail_light = value;
}

double worst_search_WLP_th::getTotal_b_Machinefail_eatching() const
{
    return total_b_Machinefail_eatching;
}

void worst_search_WLP_th::setTotal_b_Machinefail_eatching(double value)
{
    total_b_Machinefail_eatching = value;
}

double worst_search_WLP_th::getTotal_b_Machinefail_probe() const
{
    return total_b_Machinefail_probe;
}

void worst_search_WLP_th::setTotal_b_Machinefail_probe(double value)
{
    total_b_Machinefail_probe = value;
}

double worst_search_WLP_th::getTotal_b_Workerfail_output() const
{
    return total_b_Workerfail_output;
}

void worst_search_WLP_th::setTotal_b_Workerfail_output(double value)
{
    total_b_Workerfail_output = value;
}

double worst_search_WLP_th::getTotal_b_Workerfail_defect() const
{
    return total_b_Workerfail_defect;
}

void worst_search_WLP_th::setTotal_b_Workerfail_defect(double value)
{
    total_b_Workerfail_defect = value;
}

double worst_search_WLP_th::getTotal_b_Workerfail_light() const
{
    return total_b_Workerfail_light;
}

void worst_search_WLP_th::setTotal_b_Workerfail_light(double value)
{
    total_b_Workerfail_light = value;
}

double worst_search_WLP_th::getTotal_b_Workerfail_eatching() const
{
    return total_b_Workerfail_eatching;
}

void worst_search_WLP_th::setTotal_b_Workerfail_eatching(double value)
{
    total_b_Workerfail_eatching = value;
}

double worst_search_WLP_th::getTotal_b_Workerfail_probe() const
{
    return total_b_Workerfail_probe;
}

void worst_search_WLP_th::setTotal_b_Workerfail_probe(double value)
{
    total_b_Workerfail_probe = value;
}

double worst_search_WLP_th::getTotal_b_DP008_worst() const
{
    return total_b_DP008_worst;
}

void worst_search_WLP_th::setTotal_b_DP008_worst(double value)
{
    total_b_DP008_worst = value;
}

double worst_search_WLP_th::getTotal_b_DP006_worst() const
{
    return total_b_DP006_worst;
}

void worst_search_WLP_th::setTotal_b_DP006_worst(double value)
{
    total_b_DP006_worst = value;
}

double worst_search_WLP_th::getTotal_b_DP005_worst() const
{
    return total_b_DP005_worst;
}

void worst_search_WLP_th::setTotal_b_DP005_worst(double value)
{
    total_b_DP005_worst = value;
}

double worst_search_WLP_th::getTotal_b_DP004_worst() const
{
    return total_b_DP004_worst;
}

void worst_search_WLP_th::setTotal_b_DP004_worst(double value)
{
    total_b_DP004_worst = value;
}

double worst_search_WLP_th::getTotal_b_DP003_worst() const
{
    return total_b_DP003_worst;
}

void worst_search_WLP_th::setTotal_b_DP003_worst(double value)
{
    total_b_DP003_worst = value;
}

double worst_search_WLP_th::getTotal_b_DP001_worst() const
{
    return total_b_DP001_worst;
}

void worst_search_WLP_th::setTotal_b_DP001_worst(double value)
{
    total_b_DP001_worst = value;
}

double worst_search_WLP_th::getB_worst_sum() const
{
    return b_worst_sum;
}

void worst_search_WLP_th::setB_worst_sum(double value)
{
    b_worst_sum = value;
}

double worst_search_WLP_th::getB_last_probe_vild_daily() const
{
    return b_last_probe_vild_daily;
}

void worst_search_WLP_th::setB_last_probe_vild_daily(double value)
{
    b_last_probe_vild_daily = value;
}

double worst_search_WLP_th::getB_accumulate_totalvild() const
{
    return b_accumulate_totalvild;
}

void worst_search_WLP_th::setB_accumulate_totalvild(double value)
{
    b_accumulate_totalvild = value;
}

double worst_search_WLP_th::getB_daily_totalvild() const
{
    return b_daily_totalvild;
}

void worst_search_WLP_th::setB_daily_totalvild(double value)
{
    b_daily_totalvild = value;
}
...
void worst_search_WLP_th::run()
{
    ...
    b_daily_worstcpsprocesslist.clear();
    accumulate_worstcpsprocesslist.clear();
    b_accumulate_worstcpsprocesslist.clear();
    rework_worstcpsprocesslist.clear();
    b_rework_worstcpsprocesslist.clear();
    defect_worstcpsprocesslist.clear();
    b_defect_worstcpsprocesslist.clear();

    last_probe_vild_daily=0;

    daily_totalvild=0;
    accumulate_totalvild=0;
    last_probe_vild_daily=0;
    worst_sum=0;

    b_daily_totalvild=0;
    b_accumulate_totalvild=0;
    b_last_probe_vild_daily=0;
    b_worst_sum=0;
    ...
    b_exterior_pattenpaticle_vaild=0;
    b_exterior_padpaticle_vaild=0;
    b_exterior_sindiseatching_vaild=0;
    b_exterior_etcpaticle_vaild=0;
    b_exterior_brigitpadworst_vaild=0;

    exterior_vaild=0;
    exterior_worst_count=0;

    b_exterior_vaild=0;
    b_exterior_worst_count=0;
    ...
    while(my_query.next()){
        ...
        data.setVield((data.getOUTPUT_SUM()+data.getEXCLUDE_YIELD_QTY_SUM())/data.getINPUT_SUM());
            if(data.getName() == tr("lastprobe_vaild")){
                b_last_probe_vild_daily = data.getVield()*100.0;
                b_last_probe_vild_daily = roundf(b_last_probe_vild_daily * 100) / 100;
            }else if(data.getName() == tr("exterior")){
                b_exterior_vaild = data.getVield()*100.0;
                b_exterior_vaild = roundf(b_exterior_vaild * 100) / 100;
               // b_exterior_worst_count = data.getDEFECT_SUM()+data.getEXCLUDE_YIELD_QTY_SUM();
            }
        }
        b_daily_worstcpsprocesslist.append(data);
    }
    b_daily_totalvild = 1.0;
    for(int i=0;i<b_daily_worstcpsprocesslist.count();i++){
        if(b_daily_worstcpsprocesslist.at(i).getVield() != 0){
            b_daily_totalvild *= b_daily_worstcpsprocesslist.at(i).getVield();
        }
    }
    b_daily_totalvild *=100.0;
    b_daily_totalvild = roundf(b_daily_totalvild * 100) / 100;
    emit sig_debug_output(QString("daily_total vaild = %1").arg(b_daily_totalvild));
#else
    ...
    while(my_query.next()){
        ...
        data.setVield((data.getOUTPUT_SUM()+data.getEXCLUDE_YIELD_QTY_SUM())/data.getINPUT_SUM());
            if(data.getName() == tr("lastprobe_vaild")){
                accumulate_b_last_probe_vild_daily = data.getVield()*100.0;
                accumulate_b_last_probe_vild_daily = roundf(accumulate_b_last_probe_vild_daily * 100) / 100;
            }else if(data.getName() == tr("exterior")){
                accumulate_b_exterior_vaild = data.getVield()*100.0;
                accumulate_b_exterior_vaild = roundf(accumulate_b_exterior_vaild * 100) / 100;
                //exterior_worst_count = data.getDEFECT_SUM()+data.getEXCLUDE_YIELD_QTY_SUM();
            }
        }
        emit sig_debug_output(INPUT_OUTPUT_SUM_query);

        b_accumulate_worstcpsprocesslist.append(data);
    }
    b_accumulate_totalvild = 1.0;
    for(int i=0;i<b_accumulate_worstcpsprocesslist.count();i++){
        if(b_accumulate_worstcpsprocesslist.at(i).getVield() != 0){
            b_accumulate_totalvild *= b_accumulate_worstcpsprocesslist.at(i).getVield();
        }
    }
    b_accumulate_totalvild *=100.0;
    b_accumulate_totalvild = roundf(b_accumulate_totalvild * 100) / 100;
    emit sig_debug_output(QString("accumulate_total = %1").arg(b_accumulate_totalvild));
#else
...
//    accumulate_exterior_worst_count = defect_sum+rework_sum+probe_sum;
...
#ifdef REAL_QUERY_WLP
    QString b_DEFECT_QTY_SUM_query = QString("SELECT SUM(DEFECT_QTY) DEFECT_SUM "
                                           "FROM [V_FAB_DEFECT_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP' "
                                           "AND EXCLUDE_YIELD_FLAG <> 'Y';")
                                           .arg(start_date_str).arg(end_date_str);
    emit sig_debug_output(b_DEFECT_QTY_SUM_query);
    ms_query.exec(b_DEFECT_QTY_SUM_query);

    ms_query.next();
    double b_defect_sum = ms_query.value("DEFECT_SUM").toDouble();

    QString b_REWORK_SUM_query = QString("SELECT SUM(REWORK_CHIP_QTY)REWORK_SUM "
                                           "FROM [V_FAB_REWORK_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP';")
                                           .arg(start_date_str).arg(end_date_str);
    emit sig_debug_output(b_REWORK_SUM_query);
    ms_query.exec(b_REWORK_SUM_query);
    ms_query.next();
    double b_rework_sum = ms_query.value("REWORK_SUM").toDouble();

    QString b_PROBE_SUM_query = QString("SELECT SUM(PROBE_INSP_QTY) PROBE_INSP_SUM "
                                           "FROM [V_FAB_PROBE_INSP_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP';")
                                           .arg(start_date_str).arg(end_date_str);
    emit sig_debug_output(b_PROBE_SUM_query);
    ms_query.exec(b_PROBE_SUM_query);
    ms_query.next();
    double b_probe_sum = ms_query.value("PROBE_INSP_SUM").toDouble();

    b_worst_sum = b_defect_sum+b_rework_sum+b_probe_sum;

    //누적
    QString accumulate_b_DEFECT_QTY_SUM_query = QString("SELECT SUM(DEFECT_QTY) DEFECT_SUM "
                                           "FROM [V_FAB_DEFECT_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP' "
                                           "AND EXCLUDE_YIELD_FLAG <> 'Y';")
                                           .arg(accumulate_start_date_str).arg(end_date_str);
    emit sig_debug_output(accumulate_b_DEFECT_QTY_SUM_query);
    ms_query.exec(accumulate_b_DEFECT_QTY_SUM_query);

    ms_query.next();
    double accumulate_b_defect_sum = ms_query.value("DEFECT_SUM").toDouble();

    QString accumulate_b_REWORK_SUM_query = QString("SELECT SUM(REWORK_CHIP_QTY)REWORK_SUM "
                                           "FROM [V_FAB_REWORK_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP';")
                                           .arg(accumulate_start_date_str).arg(end_date_str);
    emit sig_debug_output(accumulate_b_REWORK_SUM_query);
    ms_query.exec(accumulate_b_REWORK_SUM_query);
    ms_query.next();
    double accumulate_b_rework_sum = ms_query.value("REWORK_SUM").toDouble();

    QString accumulate_b_PROBE_SUM_query = QString("SELECT SUM(PROBE_INSP_QTY) PROBE_INSP_SUM "
                                           "FROM [V_FAB_PROBE_INSP_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP';")
                                           .arg(accumulate_start_date_str).arg(end_date_str);
    emit sig_debug_output(accumulate_b_PROBE_SUM_query);
    ms_query.exec(accumulate_b_PROBE_SUM_query);
    ms_query.next();
    double accumulate_b_probe_sum = ms_query.value("PROBE_INSP_SUM").toDouble();

    accumulate_b_worst_sum = accumulate_b_defect_sum+accumulate_b_rework_sum+accumulate_b_probe_sum;


    b_DEFECT_QTY_SUM_query = QString("SELECT SUM(DEFECT_QTY) DEFECT_SUM "
                                           "FROM [V_FAB_DEFECT_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND MATERIAL_GROUP = 'WLP' "
    ...
    ms_query.next();
    b_defect_sum = ms_query.value("DEFECT_SUM").toDouble();

    b_REWORK_SUM_query = QString("SELECT SUM(REWORK_CHIP_QTY)REWORK_SUM "
                                           "FROM [V_FAB_REWORK_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND OPERATION_SHORT_NAME = '%3' "
    ...
    ms_query.exec(b_REWORK_SUM_query);
    ms_query.next();
    b_rework_sum = ms_query.value("REWORK_SUM").toDouble();

    b_PROBE_SUM_query = QString("SELECT SUM(PROBE_INSP_QTY) PROBE_INSP_SUM "
                                           "FROM [V_FAB_PROBE_INSP_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                           "AND LOT_TYPE = 'B' "
                                           "AND OPERATION_SHORT_NAME = '%3' "
    ...
    ms_query.exec(b_PROBE_SUM_query);
    ms_query.next();
    b_probe_sum = ms_query.value("PROBE_INSP_SUM").toDouble();

    b_exterior_worst_count = b_defect_sum+b_rework_sum+b_probe_sum;
#else

#endif
    emit sig_debug_output(QString("b_worst_sum= %1").arg(b_worst_sum));
    emit sig_debug_output(QString("accumulate_b_worst_sum= %1").arg(accumulate_b_worst_sum));
...
#ifdef REAL_QUERY_WLP
    total_b_DP001_worst=0;
    total_b_DP003_worst=0;
    total_b_DP004_worst=0;
    total_b_DP005_worst=0;
    total_b_DP006_worst=0;
    total_b_DP008_worst=0;
    for(int j=0;j<PROBE_ITEM_LIST.count();j++){
        QString worstcount_query = QString("SELECT SUM(PROBE_INSP_QTY)PROBE_INSP_SUM "
                                           "FROM [V_FAB_PROBE_INSP_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
        ...
        if(ms_query.next()){
            int count = ms_query.value("PROBE_INSP_SUM").toInt();
            double vaild_rate;
            double temp1 = 100.0-b_daily_totalvild;
            double temp2 = b_worst_sum;
            if(count !=0){
                vaild_rate = ((count/temp2)*temp1);
                if(PROBE_ITEM_LIST.at(j)=="DP001"){     //OS 불량 .
                      total_b_DP001_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP003"){  //저주파 .
                      total_b_DP003_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP004"){  //고주파 .
                      total_b_DP004_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP005"){  //BW 불량 .
                      total_b_DP005_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP006"){ //LIMIT 불량
                      total_b_DP006_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP008"){  //VSWR불량
                      total_b_DP008_worst = vaild_rate;
                }
            }
        }
    }
...
#ifdef REAL_QUERY_WLP
    accumulate_total_b_DP001_worst=0;
    accumulate_total_b_DP003_worst=0;
    accumulate_total_b_DP004_worst=0;
    accumulate_total_b_DP005_worst=0;
    accumulate_total_b_DP006_worst=0;
    accumulate_total_b_DP008_worst=0;
    for(int j=0;j<PROBE_ITEM_LIST.count();j++){
        QString worstcount_query = QString("SELECT SUM(PROBE_INSP_QTY)PROBE_INSP_SUM "
                                           "FROM [V_FAB_PROBE_INSP_LOTS] "
                                           "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
        ...
        if(ms_query.next()){
            int count = ms_query.value("PROBE_INSP_SUM").toInt();
            double vaild_rate;
            double temp1 = 100.0-b_accumulate_totalvild;
            double temp2 = accumulate_b_worst_sum;
            if(count !=0){
                vaild_rate = ((count/temp2)*temp1);
                if(PROBE_ITEM_LIST.at(j)=="DP001"){     //OS 불량 .
                      accumulate_total_b_DP001_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP003"){  //저주파 .
                      accumulate_total_b_DP003_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP004"){  //고주파 .
                      accumulate_total_b_DP004_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP005"){  //BW 불량 .
                      accumulate_total_b_DP005_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP006"){ //LIMIT 불량
                      accumulate_total_b_DP006_worst = vaild_rate;
                }else if(PROBE_ITEM_LIST.at(j)=="DP008"){  //VSWR불량
                      accumulate_total_b_DP008_worst = vaild_rate;
                }
            }
        }
    }
    ...
    total_b_Workerfail_probe=0;
    total_b_Workerfail_eatching=0;
    total_b_Workerfail_light=0;
    total_b_Workerfail_defect=0;
    total_b_Workerfail_output=0;
    total_b_Machinefail_probe=0;
    total_b_Machinefail_eatching=0;
    total_b_Machinefail_light=0;
    total_b_Machinefail_defect=0;
    total_b_Padpaticle=0;
    total_b_Etcpaticle=0;
    total_b_Pattenpaticle=0;
    total_b_Defectpaticle=0;
    ...
    for(int j=0;j<DEFECT_ITEM_LIST.count();j++){
        ...
        if(ms_query.next()){
            ...
            if(count!=0){
                ...
                if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(probe)")){     //작업자 파손(프로브)
                    total_b_Workerfail_probe = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(eatching)")){  //작업자 파손(에칭)
                    total_b_Workerfail_eatching = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(light)")){  //작업자 파손(노광)
                    total_b_Workerfail_light = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(deposition)")){  //작업자 파손(성막)
                    total_b_Workerfail_defect = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(output)")){ //작업자 파손(출고)
                    total_b_Workerfail_output = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(probe)")){  //설비파손(프로브)
                    total_b_Machinefail_probe = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(eatching)")){  //설비파손(에칭)
                    total_b_Machinefail_eatching = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(light)")){  //설비파손(노광)
                    total_b_Machinefail_light = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(deposition)")){  //설비파손(성막)
                    total_b_Machinefail_defect = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("padpaticle")){  //패트 이물
                    total_b_Padpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("etcpaticle")){  //이외 이물
                    total_b_Etcpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("pattenpaticle")){  //패턴 이물
                    total_b_Pattenpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("paticle")){  //이물
                    total_b_Defectpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("brigit_pad_worst")){//브릿지 패드
                    total_b_brigit_pad_worst = vaild_rate;
                }
            }
        }
    }
    ...
    accumulate_total_b_Workerfail_probe=0;
    accumulate_total_b_Workerfail_eatching=0;
    accumulate_total_b_Workerfail_light=0;
    accumulate_total_b_Workerfail_defect=0;
    accumulate_total_b_Workerfail_output=0;
    accumulate_total_b_Machinefail_probe=0;
    accumulate_total_b_Machinefail_eatching=0;
    accumulate_total_b_Machinefail_light=0;
    accumulate_total_b_Machinefail_defect=0;
    accumulate_total_b_Padpaticle=0;
    accumulate_total_b_Etcpaticle=0;
    accumulate_total_b_Pattenpaticle=0;
    accumulate_total_b_Defectpaticle=0;
    ...
    for(int j=0;j<DEFECT_ITEM_LIST.count();j++){
        ...
        if(ms_query.next()){
            ...
            if(count!=0){
                ...
                if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(probe)")){     //작업자 파손(프로브)
                    accumulate_total_b_Workerfail_probe = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(eatching)")){  //작업자 파손(에칭)
                    accumulate_total_b_Workerfail_eatching = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(light)")){  //작업자 파손(노광)
                    accumulate_total_b_Workerfail_light = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(deposition)")){  //작업자 파손(성막)
                    accumulate_total_b_Workerfail_defect = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("workerfail(output)")){ //작업자 파손(출고)
                    accumulate_total_b_Workerfail_output = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(probe)")){  //설비파손(프로브)
                    accumulate_total_b_Machinefail_probe = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(eatching)")){  //설비파손(에칭)
                    accumulate_total_b_Machinefail_eatching = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(light)")){  //설비파손(노광)
                    accumulate_total_b_Machinefail_light = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("machinefail(deposition)")){  //설비파손(성막)
                    accumulate_total_b_Machinefail_defect = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("padpaticle")){  //패트 이물
                    accumulate_total_b_Padpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("etcpaticle")){  //이외 이물
                    accumulate_total_b_Etcpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("pattenpaticle")){  //패턴 이물
                    accumulate_total_b_Pattenpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("paticle")){  //이물
                    accumulate_total_b_Defectpaticle = vaild_rate;
                }else if(DEFECT_ITEM_LIST.at(j)==tr("brigit_pad_worst")){//브릿지 패드
                    accumulate_total_b_brigit_pad_worst = vaild_rate;
                }
            }
        }
    }
    ...
    total_b_Rework_paticle=0;
    total_b_Jobmiss_defect=0;
    total_b_Jobmiss_eatching=0;
    total_b_Jobmiss_light=0;
    total_b_Jobmiss_probe=0;
    ...
    for(int j=0;j<REWORK_ITEM_LIST.count();j++){
        ...
        if(ms_query.next()){
            ...
            if(count!=0){
                vaild_rate = ((count/temp2)*temp1);
                if(REWORK_ITEM_LIST.at(j)==tr("paticle")){     //이물
                    total_b_Rework_paticle = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(deposition)")){ //작업 미스(성막)
                    total_b_Jobmiss_defect = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(eatching)")){ //작업 미스(에칭)
                    total_b_Jobmiss_eatching = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(light)")){ //작업 미스(성막)
                    total_b_Jobmiss_light = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(probe)")){ //작업미스(프로브)
                    total_b_Jobmiss_probe = vaild_rate;
                }
            }
        }
    }
    ...
    accumulate_total_b_Rework_paticle=0;
    accumulate_total_b_Jobmiss_defect=0;
    accumulate_total_b_Jobmiss_eatching=0;
    accumulate_total_b_Jobmiss_light=0;
    accumulate_total_b_Jobmiss_probe=0;
    ...
    for(int j=0;j<REWORK_ITEM_LIST.count();j++){
        ...
        if(ms_query.next()){
            ...
            if(count!=0){
                vaild_rate = ((count/temp2)*temp1);
                if(REWORK_ITEM_LIST.at(j)==tr("paticle")){     //이물
                    accumulate_total_b_Rework_paticle = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(deposition)")){ //작업 미스(성막)
                    accumulate_total_b_Jobmiss_defect = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(eatching)")){ //작업 미스(에칭)
                    accumulate_total_b_Jobmiss_eatching = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(light)")){ //작업 미스(성막)
                    accumulate_total_b_Jobmiss_light = vaild_rate;
                }else if(REWORK_ITEM_LIST.at(j)==tr("jobmiss(probe)")){ //작업미스(프로브)
                    accumulate_total_b_Jobmiss_probe = vaild_rate;
                }
            }
        }
    }
...
//            qDebug()<<ms_query_2.lastQuery();
...
#ifdef REAL_QUERY_WLP
    QString b_rework_type_txt = QString("SELECT REWORK_NAME,SUM(REWORK_CHIP_QTY) AS rework_qty "
                                      "FROM [V_FAB_REWORK_LOTS] "
                                      "WHERE MOVEOUT_DTTM BETWEEN '%1' AND '%2' "
                                      "AND LOT_TYPE = 'B' "
                                      "AND MATERIAL_GROUP = 'WLP' "
    ...
    ms_query.exec(b_rework_type_txt);
    while(ms_query.next()){
        QString rework_name = ms_query.value("REWORK_NAME").toString();
        QString rework_lottype_txt = QString("SELECT REWORK_NAME,MATERIAL_ID,SUM(REWORK_CHIP_QTY) AS rework_qty,TX_COMMENT "
                                             "FROM [V_FAB_REWORK_LOTS] "
        ...
        while(ms_query_2.next()){
            ...
            rework_item.setContent(ms_query_3.value("REWORK_NAME").toString());
            rework_item.setProduct_name(rework_MATERIAL_ID);
            b_rework_worstcpsprocesslist.append(rework_item);
        }
...
//            qDebug()<<ms_query_2.lastQuery();
            ...
            b_defect_worstcpsprocesslist.append(defect_item);
        }
    }
#else
#endif
    ...
    for(int i=0;i<EXTERIOR_DEFECT_ITEM_LIST.count();i++){
        QString exterior_txt = QString("SELECT SUM(DEFECT_QTY)DEFECT_SUM "
          ...
          if(ms_query.next()){
              int count = ms_query.value("DEFECT_SUM").toInt();
              double vaild_rate;
              double temp1 = 100.0-b_exterior_vaild;
              double temp2 = b_exterior_worst_count;
              if(count!=0){
                  vaild_rate = ((count/temp2)*temp1);

                   if(EXTERIOR_DEFECT_ITEM_LIST.at(i)==tr("padpaticle")){
                        b_exterior_padpaticle_vaild = vaild_rate;
                   }else if(EXTERIOR_DEFECT_ITEM_LIST.at(i)==tr("etcpaticle")){
                        b_exterior_etcpaticle_vaild = vaild_rate;
                   }else if(EXTERIOR_DEFECT_ITEM_LIST.at(i)==tr("pattenpaticle")){
                        b_exterior_pattenpaticle_vaild = vaild_rate;
                   }else if(EXTERIOR_DEFECT_ITEM_LIST.at(i)==tr("sin_diseatching_worst")){
                        b_exterior_sindiseatching_vaild = vaild_rate;
                   }else if(EXTERIOR_DEFECT_ITEM_LIST.at(i)==tr("brigit_pad_worst")){
                        b_exterior_brigitpadworst_vaild = vaild_rate;
                   }
              }
          }
    }
